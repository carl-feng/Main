...
char comports[38][16]={"/dev/ttymxc2","/dev/ttyS1","/dev/ttyS2","/dev/ttyS3","/dev/ttyS4","/dev/ttyS5",
...
int RS232_EmptyIOBuf(int comport_number)
{
  return tcflush(Cport[comport_number], TCIOFLUSH);
}
